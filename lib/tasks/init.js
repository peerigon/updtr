...
function init(instance) {
    ...
    return Promise.resolve()
        .then(() => {
            ...
            return sequence.exec("installMissing", instance.cmds.installMissing());
        })
        .then(() => sequence.exec("collect", instance.cmds.outdated())
            .catch(err => {
                if (err.code > 1) {
                    throw err;
                }
        ...
        .then(() => {
            ...
            return instance.parse.outdated(stdout)
