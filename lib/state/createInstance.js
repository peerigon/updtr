...
function createInstance(config, sideEffects) {
    ...
    const packageManager = sideEffects.existsSync(
...
module.exports = function (config, sideEffects) {
    return createInstance(config, sideEffects || defaultSideEffects);
};
